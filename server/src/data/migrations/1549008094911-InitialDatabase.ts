...
export class InitialDatabase1549008094911 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`id` varchar(255) NOT NULL, `FirstName` varchar(255) NULL, `LastName` varchar(255) NULL, `email` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `isAdmin` tinyint NOT NULL DEFAULT 0, `adminUserId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `chart_reports` (`id` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, `periodInMilliseconds` bigint NOT NULL, `originId` varchar(255) NULL, `destinationId` varchar(255) NULL, `userId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
